 ...
 * @LastAuthor: Faith
 * @LastEditTime: 2023-05-16 15:19
 * @Description: :class="collapsed ? 'collapsed' : 'expand'"
-->
<template>
  <div class="control" :class="position">
    ...
    <transition name="fade">
      <div class="layer-panel" v-if="!collapsed">
        <div class="base-box">
          <div
            class="box"
        ...
        <div class="base-box" v-if="overLayers.length !== 0">
          <div
            class="box"
            v-for="(item, index) in overLayers"
            :key="item.key"
            @click="overLayerChange($event, item)"
          >
            <input
              type="checkbox"
              :name="item.name"
